...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await hisoka.setStatus(`${hisoka.user.name} | Runtime : ${runtime(uptime)} | Bot Developed By Kenn Team`)
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://ziy.herokuapp.com'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: ' +62 831-2338-1900'
                                }
                            }, {
                                quickReplyButton: {
...
⭔ Detail: ${detail}`
            ...
            case 'list': case 'menu': case 'help': case '?': {
                ajuss = "6283123381900@s.whatsapp.net"
                rafli = "6285877530537@s.whatsapp.net"
                anu = `Selamat *${salam}* ${pushname} 👋
Saya ${botname}, Bot Ini Adalah Beta Multi-Device WhatsApp.
Jika Ada Fitur Error Atau Bug Segera Lapor Ke Owner Bot

  _❏ *INFO BOT*_
👤 Developer : @${ajuss.split('@')[0]}
👥 Owner 1 : @${ajuss.split('@')[0]}
👥 Owner 2 : @${rafli.split('@')[0]}
🤖 Bot Name : *${botname}*
📑 Tanggal : *${tanggal}*
⏰ Waktu : *${time}*
